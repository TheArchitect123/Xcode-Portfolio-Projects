...
internal class FirstMeetingController : BaseTableViewController {
    
    
    let CustomSource : PhrasesDataSource = PhrasesDataSource.init(PhraseCategories.FirstTimeMeeting);
